	...
	public class Shapes extends Application
	{
		...
		public void start (Stage stage)
		{
			...
			{ 
			  if(Arrays.asList(validShapes).contains(inputShape.getText().toLowerCase()))
			  {
					...
					updateCanvas(gc, shape, color, display);				
			  }
			  else
			  {
		...
		public GraphicsContext drawShape(GraphicsContext gc, String shapeIn, TextArea displayIn)
		{
			//draw shape
		...
		public GraphicsContext updateCanvas(GraphicsContext gc, String shapeIn, String colorIn, TextArea displayIn)
		{
		 	//clear canvas
			...
			displayIn.setText("Success!"); 
		 	...
		 	setColor(gc, colorIn);
			drawShape(gc, shapeIn, displayIn);
